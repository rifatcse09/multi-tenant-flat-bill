                ...
                <form method="POST" action="{{ route('admin.owners.store') }}">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        <a href="{{ route('admin.owners.index') }}"
                            class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-50 transition">
                            Cancel
                        </a>
                        <button type="submit"
        ...
        <div class="mt-6 bg-brand-50 border border-brand-200 rounded-lg p-4">
            <div class="flex items-start">
                <div class="flex-shrink-0">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-brand-800">Owner Account Information</h3>
                    <div class="text-sm text-brand-800 mt-1">
